...
class CryptoChatbot:
    ...
    def _load_chat_dataset(self):
        ...
        try:
            ...
            return {
                ...
                'sub_zero_responses': ["Let me break that down for you - Sub-Zero style!"],                'sub_zero_jokes': ["Ice to meet you in the crypto world!"]
            }
    ...
    def detect_query_intent(self, text):
        ...
        # Check for name/identity inquiries
        if any(phrase in text_lower for phrase in ['what is your name', 'who are you', 'what are you', 'tell me about yourself']):
            return 'name_inquiry'
    ...
    def generate_response(self, user_input, market_data=None, selected_coin=None):
        ...
        if intent == 'name_inquiry':
            # Handle name/identity questions with Sub-Zero responses
            name_responses = [
                ...
                "Call me Sub-Zero - your ice-cold crypto analysis companion! ⚡❄️",
                "I am Sub-Zero, grandmaster of the Lin Kuei and expert in cryptocurrency! 🥶"
            ]
            return {
                'type': 'name_response',
